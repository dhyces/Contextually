...
//import dhyces.contextually.client.core.conditions.serializers.IConditionSerializer;
...
//
//public record TargetEntityNbtCondition(CompoundTag testTag) implements IContextCondition, INamed {
//
